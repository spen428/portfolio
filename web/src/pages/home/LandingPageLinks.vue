<template>
  <div class="mb-16 flex flex-col items-center gap-6">
    ...
    <a class="text-cv-white" href="https://github.com/spen428" target="_blank">
      <button
        class="inline-flex items-center gap-2 rounded-lg border px-4 py-2 duration-500 hover:bg-cv-white hover:bg-opacity-30"
      >
        {{ $t("open_my_github") }}
        <img
